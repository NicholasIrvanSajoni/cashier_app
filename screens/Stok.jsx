            ...
            <View style={stokStyle.header}>
                <TouchableOpacity onPress={() => navigation.navigate('Home')}>
                    <View style={stokStyle.rightheader}>
                        <Image style={stokStyle.leftheader} source={require('../assets/images/Icon/arrowleft.png')}></Image>
                    </View>
                </TouchableOpacity>
                ...
                <View style={stokStyle.content}>
                    ...
                    <View style={stokStyle.actionbar}>
                        <View style={stokStyle.searchprodukbar}>
                            <Searchbar style={stokStyle.Searchbarstyle}
                                placeholder="Search"
                        ...
                        <View style={stokStyle.iconfilterbox}>
                            <Image style={stokStyle.iconfilter} source={require('../assets/images/Icon/filter.png')}></Image>
                        </View>
                    </View>
                        ...
                        <View style={stokStyle.itemcart}>
                            ...
                            />
                                ...
                                <View style={stokStyle.itemcartboximage}>
                                    <Image style={stokStyle.itemcartimage} source={require('../assets/images/tes.png')}></Image>
                                </View>
                                <View style={stokStyle.deskripsiitem}>
                                    ...
                                    <View>
                                        <Text style={stokStyle.textharga}>156.000</Text>
                                    </View>
                                ...
                                <View style={stokStyle.trashiconbox}>
                                    <Image style={stokStyle.trashicon} source={require('../assets/images/Icon/trash.png')}></Image>
                                </View>
                            </View>
                        </View>
